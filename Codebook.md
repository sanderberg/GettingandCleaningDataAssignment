# Wearable Tech Data Codebook

*This codebook refers to the dataset contained in* `tidy_data.txt`

## Data 

The `tidy_data.txt` data file is a text file with space-separated values.
...
- Subject
	...
	Anonymous subject identifier, integer, ranges from 1 to 30.
...
1. The activity identifiers (originally coded as integers between 1 and 6) were replaced with descriptive activity names (see Identifiers section).
